...
namespace BusinessLogicLayer.Services
{
    ...
    {
        public async Task SendPromotionalEmailAsync(string recipientEmail, string clientName, string promotionName, string amount, string description, string endDate)
        {
            string emailBody = GenerateEmailBody(clientName, promotionName, amount, description, endDate);
            await SendEmailAsync(recipientEmail, "Exclusive Promotion for You!", emailBody);
        }

        public string GenerateEmailBody(string clientName, string promotionName, string amount, string description, string endDate)
        {
            return $@"
        <html>
